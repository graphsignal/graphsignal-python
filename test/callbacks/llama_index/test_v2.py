...
class LlamaIndexCallbackHandlerTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_callback(self, mocked_upload_span):
        ...
        Settings.llm = FakeListLLM(responses=['three'])
        ...
        self.assertEqual(query_span.root_span_id, query_span.span_id)
        ...
        self.assertEqual(retrieve_span.root_span_id, query_span.span_id)
        ...
        self.assertEqual(synthesize_span.root_span_id, query_span.span_id)
        ...
        self.assertEqual(llm_span.root_span_id, query_span.span_id)
        ...
        self.assertEqual(fake_llm_span.root_span_id, query_span.span_id)
