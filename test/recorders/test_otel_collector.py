...
import graphsignal
from graphsignal.recorders.otel_collector import OTELCollector
...
class OTELCollectorTest(unittest.TestCase):
    ...
    def test_collector_span_processing(self):
        """Test that the collector actually processes spans and calls the callback."""
        received_spans = []
    ...
    def test_collector_grpc_connection(self):
        """Test that we can actually connect to the collector via gRPC."""
